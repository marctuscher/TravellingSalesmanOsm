...
var store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["d" /* createStore */])(reducers, initialState, Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_2_redux_thunk__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__services_core_middleware__["a" /* default */]));
					...
					case "APX":
						...
						axios({
							...
							store.dispatch(__WEBPACK_IMPORTED_MODULE_0__actions__["createNotification"]({
								...
								sticky: true,
								appState: "tsp",
								content: '<h6 style="color:#44bd32">Calculation Times:</h6></br>' + 'Finding Nodes: ' + getSecondsString(res.data["duration:localization"]) + '</br>' + 'Dijkstra: ' + getSecondsString(res.data["duration:dijkstra"]) + '</br>' + 'TSP: ' + getSecondsString(res.data["duration:compute"]) + '</br>' + 'Costs before swap: ' + res.data.costs + '</br>' + 'Costs: ' + res.data.costs
							}));
							action = processResult(res, action, store);
							next(action);
						}).catch(function (err) {
...
//# sourceMappingURL=0.973c8d3c71251d95ca4e.hot-update.js.map